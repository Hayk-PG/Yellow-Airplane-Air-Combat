...
public class SettingsInputManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        _buttons[1].OnSelect += () => { GameEventHandler.RaiseEvent(GameEventType.ResetGameSpeed); MyScene.Manager.LoadTargetScene(0); };
        _buttons[2].OnSelect += () => { GameEventHandler.RaiseEvent(GameEventType.ResetGameSpeed); MyScene.Manager.LoadTargetScene(1); };
